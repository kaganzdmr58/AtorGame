...
public class MainActivityIlk extends AppCompatActivity {
    ...
    private Timer timerx11 = new Timer();
    ...
    private CountDownTimer countDownTimerx11;
    ...
    public void onBackPressed() {
        ...
        if(countDownTimerx11 != null)
            countDownTimerx11.cancel();
        if (timerx11 != null) {
            timerx11.cancel();
            timerx11 = null;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ilk);
        ...
        cl.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (!baslangicKontrol) {
                    ...
                    timerx11.schedule(new TimerTask() {
                        @Override
                        public void run() {
    ...
    private void yemeSesi(){
        ...
        final MediaPlayer sesYeme = MediaPlayer.create(MainActivityIlk.this, R.raw.eat_2_potato);
        if (sesDurum) {
            sesYeme.start();
        }
    }
