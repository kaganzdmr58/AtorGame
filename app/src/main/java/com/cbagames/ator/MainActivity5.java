...
public class MainActivity5 extends AppCompatActivity {
    ...
    private CountDownTimer countDownTimerx5,countDownTimerx51;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewIslemGoster = findViewById(R.id.textViewIslemGoster2);
        ...
        countDownTimerx5=new CountDownTimer(45000,1000) {
            @Override
    ...
    public void gecis(int gidecekPuan,int can){
        ...
        //https://fatihdemirag.net/android-sayac-yapimi-timer/
        countDownTimerx51=new CountDownTimer(2000,1000) {
            @Override
            public void onTick(long millisUntilFinished) {
            }
            @Override
