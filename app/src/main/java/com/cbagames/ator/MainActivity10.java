...
public class MainActivity10 extends AppCompatActivity {
    ...
    public void cisimleriHareketEttir(){
        ...
        saridaireHız = Math.round(ekranGenisliği/60);  // 760 / 60 = 26
        siyahkareHiz = Math.round(ekranGenisliği/60);  // 760 / 60 = 26
        kirmiziucgenHız = Math.round(ekranGenisliği/30);  // 760 / 30 = 13
