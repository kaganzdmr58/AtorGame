...
public class MainActivity2 extends AppCompatActivity {
    private ImageView eksi,anaKarakter,arti,sifir,carpi,bol,imageViewYonOku,imageViewSettings,bonus;
    ...
    private Timer timerx2 = new Timer();
    ...
    private CountDownTimer countDownTimerx2;

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        countDownTimerx2.cancel();
        timerx2.cancel();
        timerx2 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewYonOku = findViewById(R.id.imageViewYonOku);
        ...
        bonusZamanlayici =  (int) Math.floor(Math.random() * 25);
        ...
        artiSayi = 2;//puanUret(9,1);
        eksiSayi = 2;//puanUret(9,1);
        boluSayi = 2;//puanUret(2,2);
        carpiSayi = 2;//puanUret(2,2);
...
/*
        ...
        countDownTimerx2=new CountDownTimer(30000,1000) {
            @Override
        ...
        cl.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (!baslangicKontrol) {
                    ...
                    timerx2.schedule(new TimerTask() {
                        @Override
                        public void run() {
    ...
    private void yemeSesi(){
        ...
        final MediaPlayer sesYeme = MediaPlayer.create(MainActivity2.this, R.raw.eat_2_potato);
        if (sesDurum) {
            sesYeme.start();
        }
    }
    ...
    public void carpismaKontrol(){
        ...
        if (    saridaireMerkezX >= sayix  && saridaireMerkezX <= sayix + anakarakterGenisligi &&
            ...
            //textViewSkor.setText("sarı Çarpışma gerçekleşti.");
            if (hedefSayi == skor){
                gecis(hedefSayi,canSayisi);
            }else {
                yemeSesi();
        ...
        avatarSkor.setText(String.valueOf(skor));
    ...
    public int puanUret(int carpan,int artan){
        ...
        if ((bonusSayac % 25) == bonusZamanlayici){
            bonuskontrol = true;
        }
        if (bonusSayac % 25 == (bonusZamanlayici + 3) ){
