...
public class MainActivity13 extends AppCompatActivity {
    ...
    private Boolean choiceButton(Boolean durum,CardViewSiklar cardViewSiklar){
        if (durum) {
...
/*
    public void webListeGetir(){
        ...
        String url = "https://callbellapp.xyz/project/oy_03_soru/oy_03_sorular_all_table.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i<dizi.length(); i++ ) {
                        ...
                        int soruId = q.getInt("soru_id");
                        int soruCevap = q.getInt("soru_cevap");
                        int soruKategori = q.getInt("soru_kategori");
                        String soru = q.getString("soru");
                        String soruSıkA = q.getString("soru_sk_a");
                        String soruSıkB = q.getString("soru_sk_b");
                        String soruSıkC = q.getString("soru_sk_c");
                        String soruSıkD = q.getString("soru_sk_d");

                        Soru sorux = new Soru(soruId,soruCevap,soruKategori,soru,soruSıkA,soruSıkB,soruSıkC,soruSıkD);
                        soruList.add(sorux);
                        //Toast.makeText(MainActivity13.this, "web", Toast.LENGTH_SHORT).show();
        ...
        Volley.newRequestQueue(MainActivity13.this).add(stringRequest);
